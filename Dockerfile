...
RUN mkdir -p /go/src/github.com/sergge1/txwifi
COPY . /go/src/github.com/sergge1/txwifi

RUN CGO_ENABLED=0 go build -a -installsuffix cgo -o /go/bin/wifi /go/src/github.com/sergge1/txwifi/main.go
